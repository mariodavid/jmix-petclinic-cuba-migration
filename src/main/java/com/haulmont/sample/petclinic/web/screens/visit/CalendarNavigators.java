...
public class CalendarNavigators {
    ...
    public CalendarNavigation forMode(
        ...
        switch (mode) {
            case DAY:
                return new DayCalendarNavigation(screenAdjustment, datatypeFormatter);
            case WEEK:
                return new WeekCalendarNavigation(screenAdjustment, userSessionSource.getLocale());
            case MONTH:
                return new MonthCalendarNavigation(screenAdjustment, userSessionSource.getLocale());
        }
